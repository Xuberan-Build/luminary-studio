...
const cases: Case[] = [
  ...
  },
  {
    ...
    quote:
      "With Austin we saw 5× growth in leads and 10× ROI.",
  ...
  },
  {
    ...
    summary:
      "Targeted content program and keyword expansion to widen organic reach.",
    bullets: [
          ...
          >
            ...
            {c.quote && (
              ...
              >
                {c.quote}
                {c.cite && (
                  <footer style={{ marginTop: ".25rem", opacity: 0.8 }}>
                    — {c.cite}
                  </footer>
                )}
              </blockquote>
