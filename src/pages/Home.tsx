...
export default function Home() {
  ...
  // Trigger the flash only after the user has scrolled and the services section enters
  useEffect(() => {
  ...
  return (
    <>
        ...
        <article className="stack" aria-labelledby="resume-name">
          <header className="stack">
            ...
            <p style={{ margin: 0 }}>
              ...
              <a href="mailto:austin.j.santos.93@gmail.com">
                austin.j.santos.93@gmail.com
              </a>{" "}
              · Website ·{" "}
              <a
          ...
          <section className="stack" aria-labelledby="exp-h">
            ...
            >
              <p style={{ margin: 0, color: "#fff" }}>
                <strong>Director Digital Marketing</strong> · Locus Digital ·
                Irvine, Texas · <em>Mar 2022 – Present</em>
              </p>
              <ul className="stack" style={{ margin: 0, paddingLeft: "1.1rem" }}>
                <li>
                  Spearheaded holistic marketing service transformation, driving{" "}
                  <strong>300% client retention</strong> and <strong>20× CLV</strong>,
                  generating <strong>$2.5M</strong> incremental revenue.
                </li>
                <li>
                ...
                <li>
                  Retention model & service ecosystem overhaul:{" "}
                  <strong>10×</strong> content engagement and <strong>500%</strong> potential
            ...
            >
              <p style={{ margin: 0, color: "#fff" }}>
                <strong>Senior Marketing Executive</strong> · Xuberan Digital ·
                Roanoke, Texas · <em>Jul 2021 – Present</em>
              </p>
              <ul className="stack" style={{ margin: 0, paddingLeft: "1.1rem" }}>
                <li>
            ...
            >
              <p style={{ margin: 0, color: "#fff" }}>
                <strong>Sales &amp; Marketing Operations Director</strong> · Sunday
                Roast · Lindsay, Ontario · <em>Jan 2021 – Apr 2022</em>
              </p>
              <ul className="stack" style={{ margin: 0, paddingLeft: "1.1rem" }}>
                <li>
            ...
            >
              <p style={{ margin: 0, color: "#fff" }}>
                <strong>SEO Specialist</strong> · Meridian Media Works ·
                Wilmington, NC · <em>Jan 2018 – Jan 2021</em>
              </p>
              <ul className="stack" style={{ margin: 0, paddingLeft: "1.1rem" }}>
                <li>
                  <strong>$4M+</strong> direct sales and <strong>$12M</strong> in pipeline via
                  SEO.
                </li>
          ...
          >
            ...
            <p style={{ margin: 0 }}>
              ...
              Integration · Analytics &amp; Performance · Attribution · KPI Dev · Paid
              Search · Programmatic · A/B Testing · Content Strategy · SEO · Email ·
              Lifecycle · Personalization · Acquisition · CRO · Retention · MarTech ·
              CRM · Automation · Budget &amp; ROI · Cross-functional Leadership.
            </p>
            <p style={{ margin: 0 }}>
              <strong>Tools:</strong> Salesforce · Pardot · HubSpot · GA · Looker Studio ·
              Ahrefs · SEMrush · Google Ads · Meta Ads · Apollo · Outreach · Zapier ·
              ClickUp · Asana · Monday · HTML · CSS · React · Webflow · Shopify ·
              WordPress · BigCommerce · Magento.
            </p>
          </section>
        </article>
      </Modal>
      ...
      {/* SERVICES (Saturn + moons) */}
      <section ref={servicesRef as any}>
        <ServicesSection />
      </section>

      {/* RESULTS (sticky header + parallax cards; no ship) */}
      <ResultsSection />
